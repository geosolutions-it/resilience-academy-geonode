...
echo "-----------------------------------------------------"
echo "STARTING resilience_academy_geonode BACKUP $(date)"
echo "-----------------------------------------------------"
...
./manage.sh backup -i -f -c $PWD/resilience_academy_geonode/br/settings_docker.ini --backup-dir /$BKP_FOLDER_NAME/
