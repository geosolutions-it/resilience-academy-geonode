...
echo "-----------------------------------------------------"
echo "STARTING resilience_academy_geonode RESTORE $(date)"
echo "-----------------------------------------------------"
...
cd /usr/src/resilience_academy_geonode/
...
SOURCE_URL=$SOURCE_URL TARGET_URL=$TARGET_URL ./resilience_academy_geonode/br/backup.sh $BKP_FOLDER_NAME/$NEW_UUID
...
echo "-----------------------------------------------------"
echo " - Original Backup of $TARGET_URL --> /$BKP_FOLDER_NAME/$NEW_UUID/"
echo "FINISHED resilience_academy_geonode RESTORE $(date)"
echo "-----------------------------------------------------"
